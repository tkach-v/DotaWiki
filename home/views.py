...
class SearchView(View):
    ...
    def get(self, request):
        ...
        if str(search_input).lower() in "heroes":
            ...
            href = "heroes"
            results_basic.append({"name": name, "description": description, "href": href})
        ...
        for hero in heroes_results:
            ...
            results_hero.append({"name": name, "description": description, "href": href})
        ...
        for item in items_results:
            ...
            results_item.append({"name": name, "description": description, "href": href})
        ...
        for cosmetic in cosmetics_results:
            ...
            results_cosmetic.append({"name": name, "description": description, "href": href})

        context = {'search_input': search_input, 'results_basic': results_basic, 'results_hero': results_hero,
                   'results_item': results_item, 'results_cosmetic': results_cosmetic}
        return render(request, self.template_name, context)
